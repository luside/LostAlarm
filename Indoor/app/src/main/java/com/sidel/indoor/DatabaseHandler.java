...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addFingerprint(Fingerprint fingerprint) {
        ...
        if(fingerprintId != -1) {
            java.util.Map<String, Integer> measurements = fingerprint.getDict();
    ...
    public Fingerprint getFingerprint(int id) {
        ...
        if (cursor.moveToFirst()) {
            ...
            // create fingerprint
            fingerprint = new Fingerprint(id,  location, measurements);
        }
    ...
    public ArrayList<Fingerprint> getAllFingerprints() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                Fingerprint fingerprint = new Fingerprint(id, location, measurements); // create fingerprint
